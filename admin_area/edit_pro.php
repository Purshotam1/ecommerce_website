...
$sel_brand="select * from brands where brand_id='$pro_brand'";

$run_brand=mysqli_query($conn,$sel_brand);

$row_brand=mysqli_fetch_array($run_brand);

$p_brand=$row_brand['brand_title'];

$sel_cat="select * from categories where cat_id='$pro_cat'";

$run_cat=mysqli_query($conn,$sel_cat);

$row_cat=mysqli_fetch_array($run_cat);

$p_cat=$row_cat['cat_title'];
   ...
   <form action="" method="post" enctype="multipart/form-data">
     ...
     <table align="center"  width="795" border="2" bgcolor="#187eae">
     	...
     	<tr>
     		...
     		<td>
     			<select name="product_brand" >
                   <option><?php echo $p_brand; ?></option>
                   <?php
     	...
     	<tr>
     		...
     		<td><input type="file" name="product_image"  /><img src="product_images/<?php echo $pro_image; ?>" width="60" hieght="60" ></td>
     	</tr>
...
<?php
  ...
  if(isset($_POST['update_post']))
  {
    ...
    $update_id=$get_id;
     ...
     $run_pro=mysqli_query($conn,$update_product);
